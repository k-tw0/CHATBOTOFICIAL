    ...
    fetch("cfg/configs.json")
      ...
      .then((data) => {
        ...
        options.forEach((option, index) => {
          ...
          dropdownItem && (dropdownItem.textContent = option);
          dropdownItem && dropdownItem.addEventListener("click", function (event) {
            selectOption(this);
          });
        });
      })
      .catch((error) => {
        ...
        // Aquí puedes realizar alguna acción adicional, si es necesario, al no poder cargar las opciones
      });
  }
